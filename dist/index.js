...
(function(e) {
  ...
  class E extends Error {
    constructor(d, c) {
      super(d), this.name = "HttpClientError", this.statusCode = c, Object.setPrototypeOf(this, E.prototype);
    }
  }
  e.HttpClientError = E;
  class m {
  ...
  class T {
    ...
    post(d, c, u) {
      return this.request("POST", d, c, u || {});
    }
    patch(d, c, u) {
      return this.request("PATCH", d, c, u || {});
    }
    put(d, c, u) {
      return this.request("PUT", d, c, u || {});
    }
    head(d, c) {
      return this.request("HEAD", d, null, c || {});
    }
    sendStream(d, c, u, g) {
      return this.request(d, c, u, g);
    }
    async getJson(d, c = {}) {
      c[i.Accept] = this._getExistingOrDefaultHeader(c, i.Accept, a.ApplicationJson);
      let u = await this.get(d, c);
      return this._processResponse(u, this.requestOptions);
    }
    async postJson(d, c, u = {}) {
      ...
      let y = await this.post(d, g, u);
      return this._processResponse(y, this.requestOptions);
    }
    async putJson(d, c, u = {}) {
      let g = JSON.stringify(c, null, 2);
      u[i.Accept] = this._getExistingOrDefaultHeader(u, i.Accept, a.ApplicationJson), u[i.ContentType] = this._getExistingOrDefaultHeader(u, i.ContentType, a.ApplicationJson);
      let y = await this.put(d, g, u);
      return this._processResponse(y, this.requestOptions);
    }
    async patchJson(d, c, u = {}) {
      let g = JSON.stringify(c, null, 2);
      u[i.Accept] = this._getExistingOrDefaultHeader(u, i.Accept, a.ApplicationJson), u[i.ContentType] = this._getExistingOrDefaultHeader(u, i.ContentType, a.ApplicationJson);
      let y = await this.patch(d, g, u);
      return this._processResponse(y, this.requestOptions);
    }
    async request(d, c, u, g) {
      if (this._disposed)
        throw new Error("Client has already been disposed.");
      let y = new URL(c), A = this._prepareRequest(d, y, g), P = this._allowRetries && w.indexOf(d) != -1 ? this._maxRetries + 1 : 1, S = 0, R;
      for (; S < P; ) {
        ...
        for (; p.indexOf(R.message.statusCode) != -1 && this._allowRedirects && N > 0; ) {
          ...
          A = this._prepareRequest(d, F, g), R = await this.requestRaw(A, u), N--;
        }
    ...
    requestRaw(d, c) {
      return new Promise((u, g) => {
        ...
        this.requestRawWithCallback(d, c, y);
      });
    }
    requestRawWithCallback(d, c, u) {
      let g;
      typeof c == "string" && (d.options.headers["Content-Length"] = Buffer.byteLength(c, "utf8"));
      let y = !1, A = (S, R) => {
        y || (y = !0, u(S, R));
      }, P = d.httpModule.request(d.options, (S) => {
        let R = new m(S);
        A(null, R);
      });
      P.on("socket", (S) => {
        ...
        g && g.end(), A(new Error("Request timeout: " + d.options.path), null);
    ...
    _getExistingOrDefaultHeader(d, c, u) {
      const g = (A) => Object.keys(A).reduce((P, S) => (P[S.toLowerCase()] = A[S], P), {});
      let y;
      return this.requestOptions && this.requestOptions.headers && (y = g(this.requestOptions.headers)[c]), d[c] || y || u;
    }
    _getAgent(d) {
      let c, u = n.getProxyUrl(d), g = u && u.hostname;
    ...
    static dateTimeDeserializer(d, c) {
      if (typeof c == "string") {
        let u = new Date(c);
        if (!isNaN(u.valueOf()))
          return u;
    ...
    async _processResponse(d, c) {
      return new Promise(async (u, g) => {
        const y = d.message.statusCode, A = {
          statusCode: y,
          result: null,
          headers: {}
        };
        ...
        let P, S;
        try {
          S = await d.readBody(), S && S.length > 0 && (c && c.deserializeDates ? P = JSON.parse(S, T.dateTimeDeserializer) : P = JSON.parse(S), A.result = P), A.headers = d.message.headers;
        } catch {
        }
        if (y > 299) {
          let R;
...
Object.defineProperty(fe, "__esModule", { value: !0 }), fe.getApiBaseUrl = fe.getProxyAgent = fe.getAuthString = void 0;
const oi = si(Ir);
function ii(e, t) {
  if (!e && !t.auth)
...
var qr = li, hi = ui, mi = fi, Mr = Function.bind, Nr = Mr.bind(Mr);
function zr(e, t, r) {
...
Re.Singular = gi.bind(), Re.Collection = Hr.bind(), ft.exports = Re, ft.exports.Hook = Re, ft.exports.Singular = Re.Singular;
var wi = ft.exports.Collection = Re.Collection;
function Kr(e) {
...
const de = Symbol("Response internals"), Fi = Me.default.STATUS_CODES;
class Q {
  constructor() {
...
class Pe {
  constructor(t) {
    ...
    dt(t) ? n = zt(t.url) : (t && t.href ? n = zt(t.href) : n = zt(`${t}`), t = {});
    let s = r.method || t.method || "GET";
    if (s = s.toUpperCase(), (r.body != null || dt(t) && t.body !== null) && (s === "GET" || s === "HEAD"))
      throw new TypeError("Request with GET/HEAD method cannot have body");
    let o = r.body != null ? r.body : dt(t) && t.body !== null ? nn(t) : null;
    x.call(this, o, {
  ...
  return x.Promise = he.Promise, new he.Promise(function(r, n) {
    ...
    s.timeout && w.once("socket", function(E) {
      ...
      const T = {
        ...
        timeout: s.timeout,
        counter: s.counter
      }, f = m.get("Content-Encoding");
      if (!s.compress || s.method === "HEAD" || f === null || E.statusCode === 204 || E.statusCode === 304) {
        l = new Q(b, T), r(l);
        return;
      }
      const d = {
      ...
      if (f == "gzip" || f == "x-gzip") {
        b = b.pipe(_e.default.createGunzip(d)), l = new Q(b, T), r(l);
        return;
      }
      ...
      if (f == "br" && typeof _e.default.createBrotliDecompress == "function") {
...
var pn = Ni;
Ht.exports = pn(ht), Ht.exports.strict = pn(fn), ht.proto = ht(function() {
...
function Wt(e, t) {
  ...
  return Object.assign(function(s, o) {
    ...
    if (!i.request || !i.request.hook)
      return dn(r.parse(i));
    const a = (l, p) => dn(r.parse(r.merge(l, p)));
  ...
  return {
    [Symbol.asyncIterator]: () => ({
      async next() {
        if (!a)
          return { done: !0 };
        const l = await s({ method: o, url: a, headers: i }), p = fa(l);
...
const ba = Tn(He), Yt = Tn(fe), ya = sa, Ta = ua, _a = ma;
...
function Ze(e, t = {}) {
  ...
  for (; ++h < l; ) {
    ...
    const f = m + "-".repeat(T) + b;
    t.alignDelimiters !== !1 && (T = m.length + T + b.length, T > a[h] && (a[h] = T), _[h] = T), w[h] = f;
  }
  ...
  for (; ++p < o.length; ) {
    ...
    for (; ++h < l; ) {
      ...
      if (t.alignDelimiters !== !1) {
        ...
        u === 114 ? f = " ".repeat(c) : u === 99 ? c % 2 ? (f = " ".repeat(c / 2 + 0.5), d = " ".repeat(c / 2 - 0.5)) : (f = " ".repeat(c / 2), d = f) : d = " ".repeat(c);
      }
      t.delimiterStart !== !1 && !h && b.push("|"), t.padding !== !1 && !(t.alignDelimiters === !1 && T === "") && (t.delimiterStart !== !1 || h) && b.push(" "), t.alignDelimiters !== !1 && b.push(f), b.push(T), t.alignDelimiters !== !1 && b.push(d), t.padding !== !1 && b.push(" "), (t.delimiterEnd !== !1 || h !== l - 1) && b.push("|");
    }
...
var fc = /^\s+/;
function dc(e) {
  return e && e.slice(0, pc(e) + 1).replace(fc, "");
}
function Qe(e) {
  var t = typeof e;
...
var Zn = typeof exports == "object" && exports && !exports.nodeType && exports, Xn = Zn && typeof module == "object" && module && !module.nodeType && module, Zc = Xn && Xn.exports === Zn, Qn = Zc ? J.Buffer : void 0, Xc = Qn ? Qn.isBuffer : void 0, Qc = Xc || Yc, sr = Qc, el = "[object Arguments]", tl = "[object Array]", rl = "[object Boolean]", nl = "[object Date]", sl = "[object Error]", ol = "[object Function]", il = "[object Map]", al = "[object Number]", cl = "[object Object]", ll = "[object RegExp]", ul = "[object Set]", pl = "[object String]", fl = "[object WeakMap]", dl = "[object ArrayBuffer]", hl = "[object DataView]", ml = "[object Float32Array]", gl = "[object Float64Array]", wl = "[object Int8Array]", bl = "[object Int16Array]", yl = "[object Int32Array]", Tl = "[object Uint8Array]", _l = "[object Uint8ClampedArray]", El = "[object Uint16Array]", vl = "[object Uint32Array]", U = {};
U[ml] = U[gl] = U[wl] = U[bl] = U[yl] = U[Tl] = U[_l] = U[El] = U[vl] = !0, U[el] = U[tl] = U[dl] = U[rl] = U[hl] = U[nl] = U[sl] = U[ol] = U[il] = U[al] = U[cl] = U[ll] = U[ul] = U[pl] = U[fl] = !1;
function Ol(e) {
...
var Iu = je(J, "DataView"), ur = Iu, Bu = je(J, "Promise"), pr = Bu, Lu = je(J, "Set"), fr = Lu, cs = "[object Map]", qu = "[object Object]", ls = "[object Promise]", us = "[object Set]", ps = "[object WeakMap]", fs = "[object DataView]", Mu = Ee(ur), Nu = Ee(rt), zu = Ee(pr), Hu = Ee(fr), Wu = Ee(rr), Oe = De;
(ur && Oe(new ur(new ArrayBuffer(1))) != fs || rt && Oe(new rt()) != cs || pr && Oe(pr.resolve()) != ls || fr && Oe(new fr()) != us || rr && Oe(new rr()) != ps) && (Oe = function(e) {
...
var ds = Oe, Ku = J.Uint8Array, hs = Ku, Vu = "__lodash_hash_undefined__";
function Ju(e) {
...
function ms(e, t, r, n, s, o) {
  ...
  for (o.set(e, t), o.set(t, e); ++w < a; ) {
    ...
    if ($) {
      if (!Zu(t, function(T, f) {
        if (!Xu($, f) && (E === T || s(E, T, r, n, o)))
          return $.push(f);
      })) {
        _ = !1;
        break;
...
var np = 1, sp = 2, op = "[object Boolean]", ip = "[object Date]", ap = "[object Error]", cp = "[object Map]", lp = "[object Number]", up = "[object RegExp]", pp = "[object Set]", fp = "[object String]", dp = "[object Symbol]", hp = "[object ArrayBuffer]", mp = "[object DataView]", gs = me ? me.prototype : void 0, dr = gs ? gs.valueOf : void 0;
...
function Tp(e, t, r, n, s, o) {
  ...
  for (var b = i; ++w < l; ) {
    ...
    var T = e[_], f = t[_];
    if (n)
      var d = i ? n(f, T, _, t, e, o) : n(T, f, _, e, t, o);
    if (!(d === void 0 ? T === f || s(T, f, r, n, o) : d)) {
      m = !1;
      break;
    }
    b || (b = _ == "constructor");
...
function vp(e, t, r, n, s, o) {
  var i = Y(e), a = Y(t), l = i ? bs : ds(e), p = a ? bs : ds(t);
...
var Xp = Object.defineProperty, Qp = Object.defineProperties, ef = Object.getOwnPropertyDescriptors, Rs = Object.getOwnPropertySymbols, tf = Object.prototype.hasOwnProperty, rf = Object.prototype.propertyIsEnumerable, $s = (e, t, r) => t in e ? Xp(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, nf = (e, t) => {
  for (var r in t || (t = {}))
    tf.call(t, r) && $s(e, r, t[r]);
  if (Rs)
    for (var r of Rs(t))
      rf.call(t, r) && $s(e, r, t[r]);
  return e;
}, sf = (e, t) => Qp(e, ef(t));
const of = (e) => (e < 1e-3 ? e = mr(e, 4) : e < 0.01 ? e = mr(e, 3) : e = mr(e, 2), e.toLocaleString(void 0, {
  style: "percent",
...
const cf = (e) => e < 0 ? "\u2193" : e > 0 ? "\u2191" : "", nt = ({ delta: e, percent: t }) => e ? t + cf(e) : "";
function lf({
  headPkgData: e,
  basePkgData: t,
  sortBy: r,
...
var st = {}, Fe = {}, H = {}, gr = {};
(function(e) {
  var t = O && O.__createBinding || (Object.create ? function(m, b, T, f) {
    f === void 0 && (f = T), Object.defineProperty(m, f, { enumerable: !0, get: function() {
      return b[T];
    } });
  } : function(m, b, T, f) {
    f === void 0 && (f = T), m[f] = b[T];
    ...
    return r(b, m), b;
  }, s = O && O.__awaiter || function(m, b, T, f) {
    function d(c) {
    ...
    return new (T || (T = Promise))(function(c, u) {
      ...
      function A(P) {
        P.done ? c(P.value) : d(P.value).then(g, y);
      }
      A((f = f.apply(m, b || [])).next());
    });
  }, o;
  ...
  function w(m, b) {
    return s(this, void 0, void 0, function* () {
      ...
      try {
        ...
        d.code !== "ENOENT" && console.log(`Unexpected error attempting to determine if executable file exists '${m}': ${d}`);
      }
      if (T && T.isFile()) {
        if (e.IS_WINDOWS) {
          const d = a.extname(m).toUpperCase();
          if (b.some((c) => c.toUpperCase() === d))
            return m;
        } else if ($(T))
          return m;
      }
...
var pf = O && O.__createBinding || (Object.create ? function(e, t, r, n) {
  n === void 0 && (n = r), Object.defineProperty(e, n, { enumerable: !0, get: function() {
    return t[r];
  } });
} : function(e, t, r, n) {
  n === void 0 && (n = r), e[n] = t[r];
}), ff = O && O.__setModuleDefault || (Object.create ? function(e, t) {
  Object.defineProperty(e, "default", { enumerable: !0, value: t });
} : function(e, t) {
  e.default = t;
  ...
  if (e != null)
    for (var r in e)
      r !== "default" && Object.hasOwnProperty.call(e, r) && pf(t, e, r);
  return ff(t, e), t;
...
const df = Tr.default, ks = wr(vr.default), X = wr(qe.default), Ds = Er.default, k = wr(gr), Us = Ds.promisify(ks.exec), hf = Ds.promisify(ks.execFile);
function mf(e, t, r = {}) {
  return ge(this, void 0, void 0, function* () {
    const { force: n, recursive: s, copySourceDirectory: o } = wf(r), i = (yield k.exists(t)) ? yield k.stat(t) : null;
    if (i && i.isFile() && !n)
      return;
...
function js(e) {
  return ge(this, void 0, void 0, function* () {
    if (k.IS_WINDOWS) {
      ...
      t ? yield hf("rm", ["-rf", `${e}`]) : yield k.unlink(e);
    }
  });
}
var Fs = H.rmRF = js;
function br(e) {
  return ge(this, void 0, void 0, function* () {
    df.ok(e, "a path argument must be provided"), yield k.mkdir(e, { recursive: !0 });
  });
}
H.mkdirP = br;
function xs(e, t) {
...
var bf = O && O.__createBinding || (Object.create ? function(e, t, r, n) {
  n === void 0 && (n = r), Object.defineProperty(e, n, { enumerable: !0, get: function() {
    return t[r];
  } });
} : function(e, t, r, n) {
  n === void 0 && (n = r), e[n] = t[r];
}), yf = O && O.__setModuleDefault || (Object.create ? function(e, t) {
  Object.defineProperty(e, "default", { enumerable: !0, value: t });
} : function(e, t) {
  e.default = t;
  ...
  if (e != null)
    for (var r in e)
      r !== "default" && Object.hasOwnProperty.call(e, r) && bf(t, e, r);
  return yf(t, e), t;
...
const At = xe(Le.default), Ms = xe(_r.default), Tf = xe(vr.default), _f = xe(qe.default), Ef = xe(H), Ns = xe(gr), vf = Oo.default, Rt = process.platform === "win32";
class Of extends Ms.EventEmitter {
  constructor(t, r, n) {
    if (super(), !t)
  ...
  exec() {
    return qs(this, void 0, void 0, function* () {
      return !Ns.isRooted(this.toolPath) && (this.toolPath.includes("/") || Rt && this.toolPath.includes("\\")) && (this.toolPath = _f.resolve(process.cwd(), this.options.cwd || process.cwd(), this.toolPath)), this.toolPath = yield Ef.which(this.toolPath, !0), new Promise((t, r) => qs(this, void 0, void 0, function* () {
        ...
        const o = this._getSpawnFileName(), i = Tf.spawn(o, this._getSpawnArgs(n), this._getSpawnOptions(this.options, o));
        let a = "";
...
class yr extends Ms.EventEmitter {
  ...
  CheckComplete() {
    this.done || (this.processClosed ? this._setResult() : this.processExited && (this.timeout = vf.setTimeout(yr.HandleTimeout, this.delay, this)));
  }
  _debug(t) {
    this.emit("debug", t);
  }
...
var Sf = O && O.__createBinding || (Object.create ? function(e, t, r, n) {
  n === void 0 && (n = r), Object.defineProperty(e, n, { enumerable: !0, get: function() {
    return t[r];
  } });
} : function(e, t, r, n) {
  n === void 0 && (n = r), e[n] = t[r];
}), Af = O && O.__setModuleDefault || (Object.create ? function(e, t) {
  Object.defineProperty(e, "default", { enumerable: !0, value: t });
} : function(e, t) {
  e.default = t;
}), Rf = O && O.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var t = {};
  if (e != null)
    for (var r in e)
      r !== "default" && Object.hasOwnProperty.call(e, r) && Sf(t, e, r);
  return Af(t, e), t;
...
st.getExecOutput = $f;
var Gf = Object.defineProperty, Cf = Object.defineProperties, kf = Object.getOwnPropertyDescriptors, Js = Object.getOwnPropertySymbols, Df = Object.prototype.hasOwnProperty, Uf = Object.prototype.propertyIsEnumerable, Ys = (e, t, r) => t in e ? Gf(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, jf = (e, t) => {
  for (var r in t || (t = {}))
    Df.call(t, r) && Ys(e, r, t[r]);
  if (Js)
    for (var r of Js(t))
      Uf.call(t, r) && Ys(e, r, t[r]);
  return e;
}, Ff = (e, t) => Cf(e, kf(t));
async function K(e, t) {
  let r = "", n = "";
  const s = Date.now(), o = await Vs(e, null, Ff(jf({}, t), {
    silent: !0,
    listeners: {
      stdout(a) {
        r += a.toString();
...
async function If({
  ...
  ce.default.existsSync("node_modules") && (G.info("Cleaning node_modules"), await Fs(qe.default.join(e, "node_modules")));
  const r = {
    cwd: e,
    ignoreReturnCode: !0
...
var qf = Object.defineProperty, Mf = Object.defineProperties, Nf = Object.getOwnPropertyDescriptors, Zs = Object.getOwnPropertySymbols, zf = Object.prototype.hasOwnProperty, Hf = Object.prototype.propertyIsEnumerable, Xs = (e, t, r) => t in e ? qf(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Wf = (e, t) => {
  for (var r in t || (t = {}))
    zf.call(t, r) && Xs(e, r, t[r]);
  if (Zs)
    for (var r of Zs(t))
      Hf.call(t, r) && Xs(e, r, t[r]);
  return e;
}, Kf = (e, t) => Mf(e, Nf(t));
let Qs = !1;
async function eo({
  ...
  if (G.info(`Current working directory: ${s}`), e && (G.info(`Checking out ref '${e}'`), await K(`git checkout -f ${e}`)), r !== "false") {
    ...
    if (r) {
      await If({ installCommand: n, cwd: s }).catch((p) => {
...
${p.message}`);
  ...
  const i = Kf(Wf({}, JSON.parse(o.stdout)), {
    ref: t,
    size: 0,
    sizeGzip: 0,
    sizeBrotli: 0
...
var Vf = Object.defineProperty, Jf = Object.defineProperties, Yf = Object.getOwnPropertyDescriptors, to = Object.getOwnPropertySymbols, Zf = Object.prototype.hasOwnProperty, Xf = Object.prototype.propertyIsEnumerable, ro = (e, t, r) => t in e ? Vf(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Qf = (e, t) => {
  for (var r in t || (t = {}))
    Zf.call(t, r) && ro(e, r, t[r]);
  if (to)
    for (var r of to(t))
      Xf.call(t, r) && ro(e, r, t[r]);
  return e;
}, ed = (e, t) => Jf(e, Yf(t));
async function td({
  pr: e,
  ...
  const { ref: w } = e.base;
  let _;
  return await xf(w) ? (G.info("HEAD is different from BASE. Triggering build."), G.startGroup("Build BASE"), _ = await eo({
    checkoutRef: w,
    refData: e.base,
    buildCommand: t
  }), G.endGroup()) : (G.info("HEAD is identical to BASE. Skipping base build."), _ = ed(Qf({}, h), {
    ref: e.base
  })), G.setOutput("basePkgData", _), r !== "false" ? lf({
    headPkgData: h,
    basePkgData: _,
    displaySize: l,
    sortBy: i,
...
const rd = On("\u{1F916} This report was automatically generated by [pkg-size-action](https://github.com/pkg-size/action/)");
(async () => {
  ...
  const { pull_request: t } = gt.payload, r = await td({
    pr: t,
